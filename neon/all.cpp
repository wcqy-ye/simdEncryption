...
//enum ByteOrder { LITTLE_ENDIAN_ORDER };
...
int main() {
    ...
    // 初始化状态数组，用于存储SHA-256哈希结果
    word32 state[8] = {
        0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a,
        0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19
    };

    // 调用 SHA256_HashMultipleBlocks_ARMV8 函数计算SHA-256哈希值
    SHA256_HashMultipleBlocks_ARMV8(state, reinterpret_cast<const word32*>(input), inputLength, LITTLE_ENDIAN_ORDER);
